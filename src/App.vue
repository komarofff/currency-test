    ...
    currencyFilter() {
      if (this.searchText) {
        ...
        this.dataFilter = this.currencyList.filter((el) => {
          ...
          // if (searchCodeElement === this.searchText.toLowerCase()) {
          //   return el
          // }
          if (searchAbbrElement === this.searchText.toLowerCase()) {
            return el
          }
          ...
          // if (searchCodeElement.includes(this.searchText.toLowerCase())) {
          //   return el
          // }

          if (searchAbbrElement.includes(this.searchText.toLowerCase())) {
            return el
          }
        })
